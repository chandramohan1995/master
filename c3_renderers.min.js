(function() {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    makePlotlyChart = function(traceOptions, layoutOptions, transpose) {
      ...
      return function(pivotData, opts) {
        ...
        data = traceKeys.map(function(traceKey) {
          var datumKey, labels, trace, val, values, _i, _len;
          values = [];
          labels = [];
          for (_i = 0, _len = datumKeys.length; _i < _len; _i++) {
            datumKey = datumKeys[_i];
    ...
    makePlotlyScatterChart = function() {
      return function(pivotData, opts) {
        var colKey, colKeys, data, defaults, layout, renderArea, result, rowKey, rowKeys, v, _i, _j, _len, _len1;
        defaults = {
          localeStrings: {
            vs: "vs",
            by: "by"
